...
function OrderRow({
    ...
    return (
        <div
            ...
            className="book-row book-row-reflow relative grid h-[22px] max-md:h-8 shrink-0 cursor-pointer grid-cols-3 items-center px-2 max-sm:px-1 font-mono text-[11px] max-md:text-[12px] hover:bg-bg-row active:bg-brand/10"
        >
            <div
                ref={depthRef}
                data-depth-bar
